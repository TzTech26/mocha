...
export default function Navbar() {
  ...
  return (
    <Show when={!location.pathname.includes('/route/')}>
      {/* Above the ad rails, which are fixed to the edges and would otherwise
          sit over the buttons at this end of it. */}
      <div class="navbar relative z-40 m-3.5 w-[calc(100vw-1.75rem)] rounded-btn bg-base-300 px-6">
        <div class="navbar-start">
          <A href="/">
            <div class="btn btn-ghost -ml-2 flex h-11 min-h-11 gap-3">
              ...
              {/* Not a heading: this is on every page, and a page whose first
                  heading is the site's name has told a crawler nothing about
                  itself. The heading belongs to whatever the page is about. */}
              <span class="text-2xl font-semibold">Mocha</span>
            </div>
          </A>
        </div>
